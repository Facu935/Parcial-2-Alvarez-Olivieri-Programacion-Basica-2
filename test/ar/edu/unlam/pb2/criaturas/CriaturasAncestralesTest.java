...
public class CriaturasAncestralesTest {
	...
	@Test
	public void queLaCriaturaAncestralSePuedaEntrenarEstablemente() throws MaximoDeEnergiaAlcanzadoException{
	...
	@Test
	public void queLaCriaturaAncestralNoPuedaBajarSuEnergiaDe100() throws MaximoDeEnergiaAlcanzadoException {
		Criatura criaturaAEntrenar = maestro.obtenerCriatura(criaturaAncestral);
		maestro.entrenarCriatura(criaturaAEntrenar, -20);
		Integer nivelEsperado = 100;
	...
	@Test
	public void queLaCriaturaAncestralAlEsforzarMuchoSeVuelvaInestable() throws MaximoDeEnergiaAlcanzadoException {
		Criatura criaturaAEntrenar = maestro.obtenerCriatura(criaturaAncestral);
