...
public abstract class Criatura implements Modificable{
	...
	private void setNivel(Integer nivel) throws MaximoDeEnergiaAlcanzadoException, EnergiaAcabadaException {
	...
	public void interactuar(Criatura otraCriatura) throws MaximoDeEnergiaAlcanzadoException, EnergiaAcabadaException{
	...
	private void setComportamiento(ComportamientoEmocional comportamiento) {
		this.comportamiento = comportamiento;
	}
