...
public class CriaturaDomesticadaTest {
	...
	@Test
	public void queUnaCriaturaDomesticadaComienceSiendoTranquila() {
	...
	public void queLaCriaturaDomesticadaNoPuedaSubirDeMásDe200DeEnergia()
			throws MaximoDeEnergiaAlcanzadoException, FaltaDeMaestriaException {
		CriaturaElemental criaturaDomesticada = new CriaturaDomesticada("Pablo", 190, Afinidades.TIERRA,
				ComportamientoEmocional.INESTABLE);
		maestro.añadirCriaturaAColeccion(criaturaDomesticada);
		Criatura criaturaAEntrenar = maestro.obtenerCriatura(criaturaDomesticada);
	...
	public void queLaCriaturaDomesticadaNoSePacifiqueSiYaEsta() throws CriaturaYaPacificadaException {
